                ...
                <div class="row justify-content-center">
                    <div class="col-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h3 class="text-center">¡Tu elige cómo!</h3>
                                <div class="row justify-content-between">
                                    <div class="col-5">
                                        <div class="card bg-secondary">
                                            <div class="card-body">
                                                <a href="https://api.whatsapp.com/send?phone=529371678906&text=¡Hola!%20Me%20gustaría%20saber%20mas%20de%20los%20cursos." class="btn btn-outline-success">
