                            ...
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-8">
                                        <img class="img-thumbnail" src="img/pexels-tima-miroshnichenko-5455010.jpg" alt="">
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-4">
                                        <div class="card">
                                            <div class="card-header">
                                                <h2 class="text-center">Servicio 24/7 x 365</h2>
                                            </div>
                                            <div class="card-body text-center">
                                                <a href="https://api.whatsapp.com/send?phone=529371890098&text=¡Hola!%20Me%20gustaría%20saber%20mas%20de%20los%20cursos." class="btn btn-outline-success">
                                                ...
                                                <a href="mailto:contacto@evleonline.com?Subject=Interesado%20en%20el%20curso" class="btn btn-outline-dark">
